...
from .messages import MinerUTask, detect_task, first_image_size, rewrite_messages_for_task
...
async def call_upstream(payload: dict[str, Any], settings: Settings) -> tuple[dict[str, Any], float]:
